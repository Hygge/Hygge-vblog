<template>
  <div class="blogs">
    ...
    <el-card class="box-card">
      <el-link :underline="false" href="#/admin/blog/add" class="btn-xie">
      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
          <span>
            <router-link type="warning" :to="{name: 'BlogEdit', params: {blogId: scope.row.id}}"
            >
             编辑
            </router-link>
          </span>
          ...
          <span>
          <el-button class="btn-text" type="text"  @click="modify(scope.row.id, scope.row.status)">回收站</el-button>
          </span>
          <el-divider direction="vertical"></el-divider>
          <span>
          <el-link  type="info" href="#" :underline="false">设置</el-link>
          </span>
          </template>
