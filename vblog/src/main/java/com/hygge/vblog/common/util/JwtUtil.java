...
public class JwtUtil {
     ...
     * @return
     */
    public  String createJWT(String jwtSec, long ttlMillis, String userId) {
     ...
     * @return
     */
    public Claims parseJWT(String jwtSec, String token) {
        try {
            // 得到DefaultJwtParser
    ...
    public String getJwtSec() {
        return jwtSec;
    }

    public void setJwtSec(String jwtSec) {
        this.jwtSec = jwtSec;
    }
